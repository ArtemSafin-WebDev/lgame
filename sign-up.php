                    ...
                    <form action="/" method="POST" class="sign-up__form">
                        <div class="sign-up__form-fields">
                            ...
                            <div class="sign-up__form-field">
                                ...
                                <input type="text" class="sign-up__form-input" required="" value="userName">
                            </div>
                            <div class="sign-up__form-field">
                                <div class="sign-up__form-label">
                                    Введите ваш Telegram<br>
                                    (можно добавить позже в настройках)
                                </div>
                                <input type="text" class="sign-up__form-input" value="@myTelegram">
                            </div>
                            <div class="sign-up__form-field">
                                <div class="sign-up__form-label">
                                    Введите пароль
